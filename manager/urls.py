...
from manager.views_ajax import add_like2comment_ajax, delete_comment_ajax, delete_book_ajax, add_rate2book_ajax
from manager.views_ajax import add_comment_ajax

urlpatterns =[
    path('add_like_comment/<int:comment_id>/<str:slug>/', AddLikeComment.as_view(), name="add-like"),
    path('add_like2comment_ajax/', add_like2comment_ajax),
    ...
    path('delete_comment_ajax/', delete_comment_ajax),
